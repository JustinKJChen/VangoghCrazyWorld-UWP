...
namespace AcerST_Demo
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private const string _kDefaultImageFileName2 = "DefaultImage2.jpg";
        private const string _kDefaultImageFileName3 = "DefaultImage3.jpg";
        private const string _kDefaultImageFileName4 = "DefaultImage4.jpg";
        private const string _kDefaultImageFileName5 = "DefaultImage5.jpg";
        private const string _kDefaultImageFileName6 = "DefaultImage6.jpg";
        ...
        uint m_outWidth, m_outHeight, m_inWidth, m_inHeight, m_index;
        ...
        private Stopwatch _fps = new Stopwatch(); //Performance Stopwatch used throughout
        ...
        private async Task LoadModelAsync(string modelFileName)
        {
            ...
            _evaluationLock.Wait();
            {
                ...
                try
                {
                    ...
                    // Load Model
                    StorageFile modelFile = await StorageFile.GetFileFromApplicationUriAsync(new Uri($"ms-appx:///Assets/model/{modelFileName}.onnx"));
                    ...
                    foreach (var inputF in m_model.InputFeatures)
                    {
                        ...
                        if (modelFileName.ToString().Contains("StarryStyle") && tfDesc != null)
                        {
        ...
        private async void UIButtonFilePick_Click1(object sender, RoutedEventArgs e)
        {
            _isfps = false;
        ...
        private async void UIButtonFilePick_Click2(object sender, RoutedEventArgs e)
        {
            _isfps = false;
            Debug.WriteLine("UIButtonFilePick_Click");
            _evaluationLock.Wait();
            ...
            try
            {
                ...
                var file = await StorageFile.GetFileFromApplicationUriAsync(new Uri($"ms-appx:///Assets/{_kDefaultImageFileName2}"));
                inputFrame = await ImageHelper.LoadVideoFrameFromStorageFileAsync(file);
        ...
        private async void UIButtonFilePick_Click3(object sender, RoutedEventArgs e)
        {
            _isfps = false;
            Debug.WriteLine("UIButtonFilePick_Click");
            _evaluationLock.Wait();
            ...
            try
            {
                ...
                var file = await StorageFile.GetFileFromApplicationUriAsync(new Uri($"ms-appx:///Assets/{_kDefaultImageFileName3}"));
                inputFrame = await ImageHelper.LoadVideoFrameFromStorageFileAsync(file);
        ...
        private async void UIButtonFilePick_Click4(object sender, RoutedEventArgs e)
        {
            _isfps = false;
            Debug.WriteLine("UIButtonFilePick_Click");
            _evaluationLock.Wait();
            ...
            try
            {
                ...
                var file = await StorageFile.GetFileFromApplicationUriAsync(new Uri($"ms-appx:///Assets/{_kDefaultImageFileName4}"));
                inputFrame = await ImageHelper.LoadVideoFrameFromStorageFileAsync(file);
        ...
        private async void UIButtonFilePick_Click5(object sender, RoutedEventArgs e)
        {
            _isfps = false;
            Debug.WriteLine("UIButtonFilePick_Click");
            _evaluationLock.Wait();
            ...
            try
            {
                ...
                var file = await StorageFile.GetFileFromApplicationUriAsync(new Uri($"ms-appx:///Assets/{_kDefaultImageFileName5}"));
                inputFrame = await ImageHelper.LoadVideoFrameFromStorageFileAsync(file);
        ...
        private async void UIButtonFilePick_Click6(object sender, RoutedEventArgs e)
        {
            _isfps = false;
            Debug.WriteLine("UIButtonFilePick_Click");
            _evaluationLock.Wait();
            ...
            try
            {
                ...
                var file = await StorageFile.GetFileFromApplicationUriAsync(new Uri($"ms-appx:///Assets/{_kDefaultImageFileName6}"));
                inputFrame = await ImageHelper.LoadVideoFrameFromStorageFileAsync(file);
                ...
                try
                {
                    ...
                    if (_inputFrame != null)
                    {
                        ...
                        try
                        {
                            ...
                            // Display result
                            //ImageFeatureValue outputImage = (results.Outputs[m_outName] as ImageFeatureValue);
                            //if (outputImage != null)
                            //{
                            //    _outputFrame = outputImage.VideoFrame;
                            //}
                            if (m_outName.Contains("transpose:0") || m_outName.Contains("Conv2D_15:0") || m_outName.Contains("add_37:0"))
                            {
                                await ImageHelper.RenderFrameAsync_out(_resultframeRenderer, _outputFrame);
                            }
                            else
                            {
                        ...
                        _fps.Stop();
                        double evalFPS = _fps.ElapsedMilliseconds;
                        double evalFPS_final = 1 / evalFPS * 1000;
                        string fps = evalFPS_final.ToString("#0.0");
                        fps = fps;
                        // inftime.Text = evalFPS.ToString("#0.0");
                        if (_isfps)
                        {
                            NotifyUser("FPS=" + fps, NotifyType.StatusMessage);
                        }
                        else
                        {
                            NotifyUser("Done! Inference time:" + evalFPS.ToString("#0.0") + "ms", NotifyType.StatusMessage);
                        }

                        //UITxtBlockPreviewProperties.Text = fps;
                    }
                    else
                    {
